...
function factory (params: { from: EmailAddress, to: EmailRecepients, code: VerificationCodeCode }): EmailTemplate {
  return {
    ...
    <body>
      <div class="container">
        <p class="brand">
          <img class="logo" src="https://XXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXX" alt="Logo" height="48" style="display:block;margin:0 auto;" />
        </p>
        <p class="message">Enter the following code to reset your password</p>
