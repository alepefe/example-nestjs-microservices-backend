...
import { IPasswordResetAttemptStore } from 'src/users/domain/password-reset-attempt-store';


export class InMemoryPasswordResetAttemptStore implements IPasswordResetAttemptStore {
